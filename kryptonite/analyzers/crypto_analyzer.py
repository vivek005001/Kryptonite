...
_WEAK_CRYPTO: list[tuple[str, str, re.Pattern[str], SeverityLevel, str]] = [
    (
        "CRYPTO-001",
        "MD5 Hash Usage",
        re.compile(r"\b(?:CC_MD5|MD5_Init|MD5_Update|MD5_Final|kCCHmacAlgMD5|CommonCrypto.*MD5)\b"),
    ...
    (
        "CRYPTO-002",
        "SHA-1 Hash Usage",
        re.compile(r"\b(?:CC_SHA1|SHA1_Init|SHA1_Update|SHA1_Final|kCCHmacAlgSHA1)\b"),
        SeverityLevel.MEDIUM,
    ...
    (
        "CRYPTO-003",
        "DES / 3DES Encryption",
        re.compile(r"\b(?:kCCAlgorithmDES|kCCAlgorithm3DES|DES_ecb_encrypt|DES_cbc_encrypt)\b"),
        SeverityLevel.HIGH,
    ...
    (
        "CRYPTO-004",
        "RC4 Stream Cipher",
        re.compile(r"\b(?:kCCAlgorithmRC4|RC4_set_key|arc4random_stir)\b"),
        SeverityLevel.HIGH,
    ...
    (
        ...
        re.compile(r"\b(?:kCCModeECB|ECB_MODE|\.ECB\b)"),
        SeverityLevel.HIGH,
    ...
    (
        ...
        "or a key derivation function (PBKDF2, Argon2).",
    ),
    (
        "CRYPTO-007",
        "Hardcoded IV / Nonce",
    ...
    (
        ...
        re.compile(r"\b(?:srand|rand\(\)|random\(\)|drand48)\b"),
        SeverityLevel.MEDIUM,
        "Use SecRandomCopyBytes or arc4random_buf for "
