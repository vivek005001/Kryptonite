...
_WEAK_CRYPTO: list[tuple[str, str, re.Pattern[str], SeverityLevel, str]] = [
    (
        "CRYPTO-001",
        "MD5 Hash Usage",
        re.compile(r"\b(?:CC_MD5|MD5_Init|MD5_Update|MD5_Final|kCCHmacAlgMD5|CommonCrypto.*MD5|MessageDigest\.getInstance\(\"MD5\"|DigestUtils\.md5)\b"),
    ...
    (
        "CRYPTO-002",
        "SHA-1 Hash Usage",
        re.compile(r"\b(?:CC_SHA1|SHA1_Init|SHA1_Update|SHA1_Final|kCCHmacAlgSHA1|MessageDigest\.getInstance\(\"SHA-?1\")\b"),
        SeverityLevel.MEDIUM,
    ...
    (
        "CRYPTO-003",
        "DES / 3DES Encryption",
        re.compile(r"\b(?:kCCAlgorithmDES|kCCAlgorithm3DES|DES_ecb_encrypt|DES_cbc_encrypt|DESede|DES/CBC|DES/ECB|Cipher\.getInstance\(\"DES)\b"),
        SeverityLevel.HIGH,
    ...
    (
        "CRYPTO-004",
        "RC4 Stream Cipher",
        re.compile(r"\b(?:kCCAlgorithmRC4|RC4_set_key|arc4random_stir|Cipher\.getInstance\(\"RC4|ARCFOUR)\b"),
        SeverityLevel.HIGH,
    ...
    (
        ...
        re.compile(r"\b(?:kCCModeECB|ECB_MODE|\.ECB\b|AES/ECB|DES/ECB|Cipher\.getInstance\(\"AES/ECB)\b"),
        SeverityLevel.HIGH,
